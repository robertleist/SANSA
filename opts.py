...
def get_args_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--dataset_file", type=str, default="coco",
                        choices=["coco", "lvis", "fss", "pascal_voc", "pascal_voc_cd", "pascal_part", "paco_part",
                                 "deepglobe", "isic",
                                 "lung", "ade20k", "multi"],
    ...
    parser.add_argument("--prompt", type=str, default="mask", choices=["mask", "scribble", "box", "point", "multi"],
    ...
    # SAM2 / Backbone
    parser.add_argument("--sam2_version", type=str, default="large", choices=["tiny", "base", "large"],
...
def get_args_parser_fsis() -> argparse.ArgumentParser:
    """Argument parser for SANSA training and inference (parent parser)."""
    parser = argparse.ArgumentParser("SANSA few-shot instance segmentation training and inference", add_help=False)
    ...
    # Data
    parser.add_argument("--data_root", type=str, default="data", help="Root directory for datasets.")
    parser.add_argument("--dataset_file", type=str, default="lvis",
                        choices=[
                            "coco",
                            "lvis",
                            "fss",
